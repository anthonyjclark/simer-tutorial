...
![QR code for pre-survey](_images/SurveyQR.jpg)

[Link to pre-survey](https://forms.gle/bfBJvpRPUux77fLYA)
...
We'll use this shared [Google Sheet](https://docs.google.com/spreadsheets/d/1PEC_fV56_3jDygerfHUIIPMVXu3e2vbP-ycm07Hfwlk/edit?usp=sharing) for questions and discussion during the tutorial. Feel free to add questions, comments, or resources related to simulation in robotics research.
...
::: {.g-col-12 .g-col-md-6}
{{< video _videos/RealLWMR.mp4 >}}
:::

::: {.g-col-12 .g-col-md-6}
{{< video _videos/SimLWMR.mp4 >}}
:::
